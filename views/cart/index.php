<?php
$this->params['header'] = 'Shopping Cart';
                                    ...
                                    <tr class="cart__table--body__items">
                                        ...
                                        <td class="cart__table--body__list">
                                            <div class="quantity__box">
                                                ...
                                                <label>
<!--                                                    data-counter need add -->
                                                    <input type="number" class="quantity__number quickview__value--number" value="1" disabled/>
                                                </label>
                                                <button type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button>
                                            </div>
                                        </td>
                                        <td class="cart__table--body__list">
                                            <span class="cart__price end">$<?= $product->price?></span>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            ...
                            <div class="continue__shopping d-flex justify-content-between">
                                <a class="continue__shopping--link" href="/store">Continue shopping</a>
                                <a href="/cart/remove-all" class="continue__shopping--clear" type="button">Clear Cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="cart__summary border-radius-10">
                            ...
                            <div class="cart__summary--footer">
                                ...
                                <ul class="d-flex justify-content-between">
                                    <li><a class="cart__summary--footer__btn primary__btn checkout" href="/cart/checkout">Check Out</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
